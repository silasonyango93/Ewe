...
public class Menu extends Activity {
    ...
    private void showmGrid(JSONArray jsonArray) {
        ...
        final RadioGroup myRadioGroup = new RadioGroup(this);
        ...
        ((ViewGroup) findViewById(R.id.radiogroup)).addView(myRadioGroup);
        ...
        mAdapter = new CustomMenuViewPagerAdapter(Menu.this, mTestData);

        // SlideshowPagerAdapter adapter = new SlideshowPagerAdapter(getSupportFragmentManager());
        viewPager.setAdapter(mAdapter);

        ShopsRVAdapter rcAdapter = new ShopsRVAdapter(Menu.this,images);
    ...
    {boolean connected;
        try {
            ...
            {images = new ArrayList<>();
                lLayout = new GridLayoutManager(Menu.this, 1, GridLayoutManager.HORIZONTAL, false);

                rView = (RecyclerView)findViewById(R.id.shops_rv);
                ...
                rlMensClothing=(RelativeLayout) findViewById(R.id.rlMensClothing);
                rlWomensClothing=(RelativeLayout) findViewById(R.id.rlWomensClothing);
                rlElectronics=(RelativeLayout) findViewById(R.id.rlElectronics);
                rlMensShoes=(RelativeLayout) findViewById(R.id.rlMensShoes);
                rlLadysShoes=(RelativeLayout) findViewById(R.id.rlLadysShoes);
                rlStationery=(RelativeLayout) findViewById(R.id.rlStationery);
                rlBedding=(RelativeLayout) findViewById(R.id.rlBedding);
                rlCosmetics=(RelativeLayout) findViewById(R.id.rlCosmetics);
                rlKitchenware=(RelativeLayout) findViewById(R.id.rlKitchenware);
                rlLaundry=(RelativeLayout) findViewById(R.id.rlLaundry);
                rlHouseHolds=(RelativeLayout) findViewById(R.id.rlHouseHolds);
                rlFood=(RelativeLayout) findViewById(R.id.rlFood);
                rlAirtime=(RelativeLayout) findViewById(R.id.rlAirtime);
                rlMensRegalia=(RelativeLayout) findViewById(R.id.rlMensRegalia);
                rlWomensRegalia=(RelativeLayout) findViewById(R.id.rlWomensRegalia);
                rlBuyersRequests=(RelativeLayout) findViewById(R.id.rlBuyersRequests);

                rlMensClothing.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(Menu.this, ProductSearchResults.class);
