...
public class SignUp extends Activity {
    DatabaseHelper myDb;
    ImageView img;
    String UserName,PhoneNo,UserPassword,Address,Campus;
    private static final String TAG = SignUp.class.getSimpleName();
    private Button btnRegister;
    private Button btnLinkToLogin;
    private EditText inputFullName;
    private EditText inputEmail;
    private EditText inputPassword,etAddress,etCampus;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // viewSpecificData();
        ...
        etCampus = (EditText) findViewById(R.id.et_Campus);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                Campus = etCampus.getText().toString().trim();
                ...
                if (!UserName.isEmpty() && !PhoneNo.isEmpty() && !UserPassword.isEmpty()&& !Address.isEmpty()&& !Campus.isEmpty()) {
    ...
    private void registerUser(final String name, final String email,
                              final String password,final String address,final String campus) {
                    ...
                    public void onClick(View v) {
                        ...
                        if(submitted==false)
                        {
                            ...
                            if(correct==true){
                                ...
                                registerUser(UserName, PhoneNo,UserPassword,Address,Campus);
                            }else {
