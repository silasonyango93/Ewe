...
public class RecyclerViewAdapterThree extends RecyclerView.Adapter<RecyclerViewHoldersThree> {
    ...
    private ArrayList<String> ProductOwnerIds;
    ...
    public RecyclerViewAdapterThree(Context context, ArrayList<String> images, ArrayList<String> ProductOwnerIds, ArrayList<String> productTypes, ArrayList<String> productMakes, ArrayList<String> productColours, ArrayList<String>  prices, ArrayList<String> otherDescriptions, ArrayList<String> productIds, ArrayList<String> periods, ArrayList<String> ownerNames ,ArrayList<String> profPicUrls) {
    ...
    public RecyclerViewHoldersThree onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(context).inflate(R.layout.card_view_list_three,null);
        RecyclerViewHoldersThree rcv = new RecyclerViewHoldersThree(layoutView,this.context);
    ...
    public void onBindViewHolder(RecyclerViewHoldersThree holder, int position) {
        ...
        holder.ProductOwnerId=(ProductOwnerIds.get(position));
