...
public class SplashScreen extends AppCompatActivity implements View.OnClickListener {
  ...
  com.example.silasonyango.ewe.PagerAdapter adapter;
    ...
    private String[] title = {"Klabuu round hii imeweza.\nTrade at the convenience of your seat.","Get Funding to realise your Dreams"};
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_asGuest:
                Intent main_intent = new Intent(getBaseContext(),GeneralPublic.class);
